...
- `internal/cmd/` — Cobra commands: root (launches TUI with project picker), `list` (non-interactive: lists projects by default, sessions with a project arg), `login` (OpenShift OAuth browser-based login), `version`.
